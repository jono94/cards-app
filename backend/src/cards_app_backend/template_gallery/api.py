...
async def list_card_templates(
    service: Annotated[CardTemplateApplicationService, Depends(Factory.create_card_template_application_service)],
) -> list[CardTemplate]:
    return await service.list_card_template()
...
async def get_card_template(
    ...
    return await service.get_card_template(card_template_id)
...
async def create_card_template(
    *,
    ...
    return await service.create_card_template(name, description, image.content_type, image_content, categories)
...
async def update_card_template(
    *,
    ...
    return await service.update_card_template(card_template_id, name, description, categories, image_type, image_content)
...
async def delete_card_template(
    ...
    return await service.delete_card_template(card_template_id)
...
async def get_image(
    ...
    file_path = await service.get_image_path(image_file_name)
